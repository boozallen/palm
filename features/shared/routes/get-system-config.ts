...
import getSystemConfig from '../dal/getSystemConfig';
import { z } from 'zod';
...
const outputSchema = z.object({
  ...
  documentLibraryKbProviderId: z.string().uuid().nullable(),
...
export default procedure.output(outputSchema).query(async () => {
  ...
  return {
    ...
    documentLibraryKbProviderId: result.documentLibraryKbProviderId || null,
