...
describe('Agent', () => {
  ...
  it('renders the CERTA agent when type matches', () => {
    render(<Agent label={agentName} id={mockAgentId} type={AiAgentType.CERTA} />);
  ...
  it('renders the RADAR agent when type matches', () => {
    render(<Agent label={agentName} id={mockAgentId} type={AiAgentType.RADAR} />);
  ...
  it('renders default message when agent is not found', () => {
    render(<Agent label={agentName} id={mockAgentId} type={0 as AiAgentType} />);
