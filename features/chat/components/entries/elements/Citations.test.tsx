...
describe('Citations', () => {
  ...
  const mockCitations = [
    ...
    { sourceLabel: 'Literature', citation: 'Shakespeare\'s Sonnets' },
    { sourceLabel: 'Computer Science', citation: 'Algorithm Analysis' },
    { sourceLabel: 'Biology', citation: `(DNA Sequencing, p. 132): ${longCitationText}` },
  ];
  ...
  it('does not render the remaining citations avatar if there are no remaining citations', () => {
    const mockCitation = [
      { sourceLabel: 'Astronomy', citation: 'Hubble\'s Law' },
    ];
