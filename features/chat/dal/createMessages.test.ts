...
describe('createMessages', () => {
  ...
  const mockNewMessages = [
    ...
    },
    {
      ...
      chatMessageCitations: [
        {
          knowledgeBaseId: mockMessages[1].citations[0].knowledgeBaseId,
          knowledgeBase: { label: 'Knowledge Base 1' },
          citation: mockMessages[1].citations[0].citation,
        },
      ],
      chatArtifacts: [
        {
  ...
  it('creates messages, citations, and artifacts successfully', async () => {
    ...
    expect(result).toEqual([
      ...
      },
      {
        ...
        citations: [
          {
            knowledgeBaseId: mockNewMessages[1].chatMessageCitations[0].knowledgeBaseId,
            knowledgeBaseLabel: mockNewMessages[1].chatMessageCitations[0].knowledgeBase.label,
            citation: mockNewMessages[1].chatMessageCitations[0].citation,
          },
        ],
        artifacts: [
          {
