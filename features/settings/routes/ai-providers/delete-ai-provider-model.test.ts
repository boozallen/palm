...
import deleteAiProviderModelDal from '@/features/settings/dal/ai-providers/deleteAiProviderModel';
...
jest.mock('@/features/settings/dal/ai-providers/deleteAiProviderModel');
