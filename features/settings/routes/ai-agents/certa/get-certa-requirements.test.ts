...
import getFirstAvailableOpenAiModel from '@/features/settings/dal/ai-providers/getFirstAvailableOpenAiModel';
...
jest.mock('@/features/settings/dal/ai-providers/getFirstAvailableOpenAiModel');
