...
jest.mock('@/features/settings/api/kb-providers/get-knowledge-bases', () => ({
  __esModule: true,
  default: jest.fn(),
}));
...
describe('KbProvidersTable', () => {
  ...
  beforeEach(() => {
    ...
    require('@/features/settings/api/kb-providers/get-kb-providers').default.mockReturnValue({
      data: mockKbProviders,
      isPending: false,
      error: null,
    });

    require('@/features/settings/api/kb-providers/get-knowledge-bases').default.mockReturnValue({
