...
import useDeleteKnowledgeBase from '@/features/settings/api/kb-providers/delete-knowledge-base';

jest.mock('@/features/settings/api/kb-providers/delete-knowledge-base');
