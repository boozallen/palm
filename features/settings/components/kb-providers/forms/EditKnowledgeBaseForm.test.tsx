...
import useUpdateKnowledgeBase from '@/features/settings/api/kb-providers/update-knowledge-base';
import { Forbidden } from '@/features/shared/errors/routeErrors';
import { notifications } from '@mantine/notifications';
import { IconX } from '@tabler/icons-react';

jest.mock('@/features/settings/api/kb-providers/update-knowledge-base');
