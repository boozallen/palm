...
import useGetAiProvider from '@/features/settings/api/ai-providers/get-ai-provider';
import useDeleteAiProvider from '@/features/settings/api/ai-providers/delete-ai-provider';

jest.mock('@/features/settings/api/ai-providers/get-ai-provider');
jest.mock('@/features/settings/api/ai-providers/delete-ai-provider');
