...
import useCreateUserGroupMembership from '@/features/settings/api/create-user-group-membership';
import { UserGroupRole } from '@/features/shared/types/user-group';
import userEvent from '@testing-library/user-event';
import { notifications } from '@mantine/notifications';
import { IconX } from '@tabler/icons-react';
import useGetUsersListWithGroupMembershipStatus from '@/features/settings/api/get-users-list-with-group-membership-status';
...
jest.mock('@/features/settings/api/create-user-group-membership');
jest.mock('@/features/settings/api/get-users-list-with-group-membership-status');
