...
import { useUpdateUserGroupKbProviders } from '@/features/settings/api/user-groups/update-user-group-kb-providers';
import { notifications } from '@mantine/notifications';
import { IconX } from '@tabler/icons-react';

jest.mock('@/features/settings/api/user-groups/update-user-group-kb-providers');
