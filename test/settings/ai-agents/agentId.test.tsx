...
jest.mock('@/features/settings/components/ai-agents/elements/certa/AgentPolicies', () => {
...
describe('AiAgentDetailsPage', () => {
  ...
  it('renders page title', () => {
    ...
    expect(title).toHaveTextContent(mockAgent.label);
  });
  ...
  it('renders breadcrumbs', () => {
    ...
    expect(breadCrumbs).toHaveTextContent(/settings/i);
    expect(breadCrumbs).toHaveAttribute('href', '/settings');
  });
});
